 ...
 */
define(function(){
    return ["$scope", "$uibModal", "UserGroupAPI", "$dialog", function($scope, $uibModal, UserGroupAPI, $dialog){
        $scope.pageSetting = {
            checkAll : false,
        ...
        $scope.openModal = function(index, action){
            $uibModal.open({
                ...
                controller: ['$scope', '$uibModalInstance', "$uibModal", "UserGroupAPI", "Params", "$dialog", function($scope, $uibModalInstance, $uibModal, UserGroupAPI, Params, $dialog){
